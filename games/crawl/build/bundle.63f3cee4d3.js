...
const scenes = {};
const S = scenes;
S["start"]={art:"door",t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The tide has gone out of the old reliquary, leaving its lower halls drowned in still black water. ${G.name}, you came down the shaft for what the guild calls the Sunken Vault — and what the dead called a tomb.`)+P(`A bronze door waits, green with brine. Someone has scratched a warning into it.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Read the warning`,go:"inscription"},{id:"c1",l:`Ignore it and descend`,go:"vestibule"}];}};
S["inscription"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The scratches resolve into words: *The Warden does not sleep. It drinks the deep and is made whole. Bind it, or break its bracing, or it will outlast you.*`)+P(`You commit it to memory. Forewarned is half-armed.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Descend into the vault`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;flag('warned');},go:"vestibule"}];}};
S["vestibule"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return ((v.warned)?(P(`The warning rings in your ears as you drop into knee-deep water. A drowned quartermaster's locker hangs open before you.`)):(P(`You drop into knee-deep water. A drowned quartermaster's locker hangs open before you, two relics catching your lamp.`)))+P(`You can take one. Your dagger you keep either way.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Take the Bronze Tideblade`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;give('blade'); equip('blade'); chronicle('Armed yourself with the Bronze Tideblade.');},go:"hall"},{id:"c1",l:`Take the Pearl Charm`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;give('charm'); equip('charm'); chronicle('Took the Pearl Charm for a steadier breath.');},go:"hall"}];}};
S["hall"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The great hall forks. Lamp-light gutters on water that laps at three passages: a guardroom where something metal still paces, a barred cell, and a silted alcove.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Force the guardroom door`,go:"guardroom"},{id:"c1",l:`Look into the barred cell`,go:"companion"},{id:"c2",l:`Search the silted alcove`,go:"alcove"}];}};
S["companion"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`A diver named Mara is chained to the cell wall, half-drowned but breathing. "Cut me loose," she rasps, "and I'll watch your back down there. I know the Warden's tricks."`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Cut her chains free`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;bond('companion', 2); flag('freed_companion'); chronicle('Cut the diver Mara free; she dives at your back now.');},go:"hall"},{id:"c1",l:`Leave her — you work alone`,go:"hall"}];}};
S["alcove"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`You rake through the silt and your fingers close on a small glass vial: a salt tonic, the kind divers carry against the cold dark.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Pocket it and return`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;give('tonic');},go:"hall"}];}};
S["guardroom"]={art:"guardroom",combat:"sentinel",win:"gallery",lose:"defeat",t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The guardroom floods to your waist. The Sentinel that paces it has not stopped its rounds in three hundred years.`);}};
S["gallery"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`Past the wrecked Sentinel, a gallery of dead lockers lines the wall. A gilded key hangs at the belt of a skeleton still seated at his post — and you finally understand the Warden's bracing.`)+((v.freed_companion)?(P(`Mara slips in behind you, prying at the lockers, covering the dark.`)):(""));},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Take the gilded key and seek the vault door`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;give('vaultkey'); learn('rend'); chronicle('Lifted the gilded vault key; learned the Rend technique.');},go:"sealeddoor"},{id:"c1",l:`Gamble — dive the flooded grate`,go:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (check('body', 10) ? 'sealeddoor' : 'guardroom');}},{id:"c2",l:`Flee out through the culvert`,go:"escape"}];}};
S["sealeddoor"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`A bronze door, twin to the one above, seals the inner vault. Its lock is a single gilded slot.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Turn the vault key in the lock`,req:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (has('vaultkey'));},rq:"the lock will not turn without its key",go:"approach"},{id:"c1",l:`Withdraw to the gallery`,go:"gallery"}];}};
S["approach"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`Beyond the door the water deepens to a black mirror. The Warden's dais waits at its center. You steady your breath.`)+((v.freed_companion)?(P(`Mara checks her pry-bar and nods. "When it sheds its shell, I'll jam the gears. Make it count."`)):(""));},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Drink the salt tonic and descend`,req:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (has('tonic'));},rq:"you have nothing to drink",do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;take('tonic'); gain('hp', 6);},go:"vault"},{id:"c1",l:`Descend cold`,go:"vault"}];}};
S["vault"]={art:"vault",combat:"warden",win:"victory",lose:"defeat",t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The Warden unfolds from the dais, brine pouring off it, and the deep goes still.`);}};
S["victory"]={ending:true,t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return SYS(`THE VAULT IS YOURS`)+P(`The Warden comes apart in the black water and does not knit again. In the quiet that follows you find the reliquary's heart: a single cold pearl the size of a fist.`)+((v.freed_companion)?(P(`Mara surfaces beside you, grinning through the murk. You did not do this alone.`)):(""))+P(`You carry it up into the light.`);}};
S["defeat"]={ending:true,t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return SYS(`THE DEEP CLOSES OVER YOU`)+P(`The water takes you down past the dais, past the dark, into the long cold the divers warned of. The vault keeps its pearl, and you.`);}};
S["escape"]={ending:true,t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return SYS(`YOU LIVE TO DIVE AGAIN`)+P(`You haul yourself up through the culvert and break the surface, lungs burning, empty-handed but breathing. The Sunken Vault keeps its secrets. There will be other tides.`);}};
