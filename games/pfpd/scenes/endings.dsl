...
ending: true
art: portal
brief: four cartoon avatars dissolving upward into a swirl of golden feed-light above a downtown alley, triumphant, pixel particles everywhere
!! ENDING: BACK ONLINE
...
ending: true
art: canceled
brief: a cartoon avatar trapped inside a phone screen drowning in red notification badges and angry replies, pixel-art mob in the background
!! ENDING: CANCELED
It happens in the time it takes to refresh. The discourse comes for you like weather. By sunset there are think-pieces. By midnight there is a fifty-minute video essay with chapter markers.

[[if v.ratiod]]
ChadGPT narrates the whole arc with visible joy.
[[end]]

The city does not arrest you and does not hire you. It simply stops making eye contact. You are still physical, still stuck, and now radioactive. The crew quietly unfollows you and splits a cab. Somewhere a brand sends thoughts and prayers, then deletes them for engagement reasons.

* Log off in shame -> start

--- end_arrested
ending: true
art: arrested
brief: a cartoon avatar in handcuffs sitting in a texas holding cell, sad fluorescent light, a deputy filling out a very confused incident report
!! ENDING: ARRESTED
The cuffs are real and surprisingly cold. The deputy spends a long time trying to spell your username in the incident report and eventually just writes "the blue one." Booking has no category for what you are. The fingerprint scanner returns an error. The mugshot, however, is incredible, and leaks within the hour.

You get one phone call. You spend it doomscrolling. Brett is in the next cell teaching the pigeon to bail him out. The feed feels very far away, on the other side of bars that are, for once, not the wifi kind.

* Await your arraignment -> start
