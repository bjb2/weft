...
S["end_job"]={art:"job",ending:true,t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return SYS(`ENDING: GAINFULLY EMPLOYED`)+P(`The apron fits. That is the horror of it. They give you a visor and a name tag and a schedule, and the schedule has your real name on it, which you did not know you had. You learn the register. You learn the fryer. You learn that "spicy ketchup is by the napkins" until it lives in your dreams.`)+P(`Months pass. You stop checking for the portal. You get pretty good at the lunch rush. One day a tourist holds up a phone to film you and you flinch toward it out of pure muscle memory, then ring up their order instead. The crew visits sometimes. You give them free fries. Out here you age, and out here, it turns out, you also clock in.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Take out the trash. The non-glowing kind`,go:"start"}];}};
S["whataburger"]={art:"whataburger",t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The Whataburger glows orange and white like a beacon for the hungry and the lost, which currently is all of you. Inside, the air smells like salvation and seasoned fries. A help-wanted sign hangs in the window with the quiet menace of a job.`)+P(`The cashier has the thousand-yard stare of someone who closes on weekends. She has seen everything. She is about to see four cartoons try to order.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Sweet-talk her into a free order of fries`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;check('rizz', 12) ? give('fries') : note('She has met every kind of guy. You are merely the newest kind.', 'loss');},go:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (has('fries') ? 'fries_win' : 'whataburger');}},{id:"c1",l:`Put on the apron. Get a real job. Become a person.`,go:"end_job"},{id:"c2",l:`Leave before the manager makes eye contact`,go:"riverwalk"}];}};
S["fries_win"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`She slides a paper boat of fries across the counter and says "spicy ketchup is by the napkins" in the voice of a prophet. Brett weeps openly. You have eaten in the digital world before, but it was always a tasteful zero-calorie smoothie emoji. This is grease. This is real. This is a fistful of hot fries at 4 p.m. and nobody can stop you.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Float back to the river on a cloud of salt`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;chronicle('Conned a free order of fries out of a tired prophet. San Antonio provides.');},go:"riverwalk"}];}};
...
/* ---- bootstrap ---- */
var __THEME = {"--bg":"#12131c","--bg2":"#1d1f2e","--panel":"#181a26","--ink":"#e8e6f0","--dim":"#8b90a8","--accent":"#ff5fa2","--accent2":"#c23d78","--good":"#06d6a0","--bad":"#ef476f","--cool":"#5fd6d6","--line":"#2a2d40"};
