...
const scenes = {};
const S = scenes;
S["start"]={art:"title",t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return `<h1>${G.def?.meta?.title||''}</h1>`+P(`Rain hammers the slates of Ashford Manor. Lord Ashford lies three days dead in the cold room, and his fortune dangles between three living hands. They sent for you, ${G.name}, because the village constable lost his nerve at the threshold.`)+P(`The steward meets you under the dripping portico, lantern raised, smile thin as a wire.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Step inside and begin`,go:"foyer"}];}};
S["foyer"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The great hall swallows the lamplight. Doors lead off in every direction, each one a question. Somewhere upstairs a clock you cannot see counts down to the reading of the will.`)+((v.met_crane)?(P(`Crane the steward hovers at the edge of the dark, watching which door you choose.`)):(P(`Crane the steward bows you in, then withdraws to watch from the shadow of the stair.`)));},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Search the study`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;flag('met_crane');},go:"study"},{id:"c1",l:`Search the library`,go:"library"},{id:"c2",l:`Descend toward the cellar`,go:"cellar"},{id:"c3",l:`Take tea with the family in the parlor`,go:"parlor"},{id:"c4",l:`Climb the back stair to the attic`,hide:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (!has('key'));},go:"attic"},{id:"c5",l:`Gather the household and make your accusation`,go:"accuse"}];}};
S["study"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The late Lord's study reeks of pipe smoke and ash. The estate ledger lies open on the desk, a fresh inkwell beside it. The figures march down the page in two different hands.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Read the columns closely`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;check('wits', 13) ? flag('ledger_clue') : note('The figures blur; you cannot fault them.', 'loss');},go:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (v.ledger_clue ? 'study_found' : 'study_miss');}},{id:"c1",l:`Leave the study`,go:"foyer"}];}};
S["study_found"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`You see it at once: a whole column of debts entered after the Lord's death, in a steadier hand than a dying man could hold. Someone has been writing the estate poorer on paper while fattening a private purse. You take the ledger.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Pocket the ledger and withdraw`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;give('ledger');},go:"foyer"}];}};
S["study_miss"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The numbers swim. Tired and rain-soaked, you cannot make the columns confess. Perhaps with a clearer head you might try again.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Return to the hall`,go:"foyer"}];}};
S["library"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`Floor to ceiling with rotting calf-bound spines. A grate of cold ashes holds one survivor: a half-burned letter, the Lord's seal still legible. *If you alter one figure more, I will see you hang* — and then the fire took the name of who he meant.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Rescue the letter from the grate`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;give('letter');},go:"foyer"},{id:"c1",l:`Leave the library`,go:"foyer"}];}};
S["cellar"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The cellar stair drops into black water-smell and the small sounds of things moving. A draught snuffs your candle halfway down. To go on you must trust your feet and your nerve.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Feel your way down into the dark`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;check('nerve', 12) ? flag('cellar_ok') : note('Your courage fails on the seventh step.', 'loss');},go:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (v.cellar_ok ? 'cellar_key' : 'cellar_fail');}},{id:"c1",l:`Climb back to the light`,go:"foyer"}];}};
S["cellar_key"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`You hold steady. At the bottom, hung on a nail behind the wine racks where no servant would bother, a brass key still warm from a recent hand. Attic-shaped. You take it and climb.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Return to the hall with the key`,do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;give('key');},go:"foyer"}];}};
S["cellar_fail"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The dark presses in and your heart bolts. You scramble back up the stairs, candle dead, hands shaking. Whatever waits below will wait.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Catch your breath in the hall`,go:"foyer"}];}};
S["parlor"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`The family takes tea as though no corpse cools overhead. Lydia, the niece, weeps on cue. Dr. Mallow, the late Lord's physician, stirs his cup and watches you over the rim. Crane pours, silent, his sleeves — you notice — stained faintly with fresh ink.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Press Lydia about her debts`,hide:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (v.read_will);},do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;note('She inherits least of the three. She knows it, and it frightens her.', 'gain');},go:"parlor"},{id:"c1",l:`Press Dr. Mallow about the death`,hide:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (v.read_will);},do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;note('Heart failure, he insists. He signed the certificate himself.', 'gain');},go:"parlor"},{id:"c2",l:`Withdraw to the hall`,go:"foyer"}];}};
S["attic"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`Under the eaves, rain drums an inch above your skull. A steamer trunk crouches in the corner, and your brass key fits its lock as if cut for it.`)+((v.read_will)?(P(`The forged will lies open across your knees: Crane's careful hand mimicking a dead man's signature, naming Crane himself residual heir.`)):(P(`The lock is stiff with disuse; forcing it will cost what little composure the night has left you. (Composure ${G.pools.composure.cur}/${G.pools.composure.max})`)));},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Force the trunk open`,req:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (G.pools.composure.cur >= 2);},rq:"your nerves are too frayed to wrestle the lock",hide:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return (v.read_will);},do:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;spend('composure', 2); flag('read_will'); note('Inside: a second will, freshly inked.', 'gain');},go:"attic"},{id:"c1",l:`Go back down the stair`,go:"foyer"}];}};
S["accuse"]={t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return P(`You ring the bell. Lydia, Mallow, and Crane assemble beneath the cold portrait of the man they are about to inherit. The clock upstairs stops. Whatever you say now, you say for the record — and for the rope.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Accuse Crane the steward`,go:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return ((has('ledger') && has('letter') && v.read_will) ? 'end_solved' : 'end_wrong');}},{id:"c1",l:`Accuse Lydia the niece`,go:"end_wrong"},{id:"c2",l:`Accuse Dr. Mallow the physician`,go:"end_wrong"},{id:"c3",l:`Say nothing. Slip out into the rain and leave them to it`,go:"end_flee"}];}};
S["end_solved"]={ending:true,t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return SYS(`THE INHERITANCE UNDONE`)+P(`You lay them side by side: the doctored ledger, the dead man's threat, the forged will from the attic trunk. Three threads, one hand. Crane's composure cracks at the word *forgery*; he is taken in irons before the clock strikes again. The estate passes clean. They will speak of the night the inspector read a house like a confession.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Close the case`,go:"start"}];}};
S["end_wrong"]={ending:true,t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return SYS(`THE WRONG NECK`)+P(`You name your suspect with a confidence the evidence cannot bear. The accused goes white, then furious, then free — your case unravels in open court within the month. The true hand collects the inheritance and a reputation for grief. You leave Ashford with the rain and keep, ever after, the cold suspicion that you held the truth and let it slip.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Live with it`,go:"start"}];}};
S["end_flee"]={ending:true,t:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return SYS(`THE ROAD AWAY`)+P(`Some houses are not meant to be solved. You set down the lamp, turn up your collar, and walk out into the storm without a backward glance. Behind you the will is read; a fortune changes hands in a manner no one will ever question. You never learn who. You tell yourself that is mercy. The road does not believe you.`);},c:($)=>{const {G,v,P,SYS,DIV,B,I,SMALL,SAY,get,set,flag,add,gain,spend,has,give,take,equip,unequip,bond,learn,check,rand,randint,note,chronicle}=$;return [{id:"c0",l:`Walk on`,go:"start"}];}};
